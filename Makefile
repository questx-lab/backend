...
contract-gen:
	solc --abi contract/src/erc20.sol --overwrite -o contract/abi/erc20
	solc --bin contract/src/erc20.sol --overwrite -o contract/abi/erc20
	solc --abi contract/src/nfts.sol --overwrite -o contract/abi/nfts
	solc --bin contract/src/nfts.sol --overwrite -o contract/abi/nfts
	abigen --bin=contract/abi/erc20/IERC20Metadata.bin --abi=contract/abi/erc20/IERC20Metadata.abi --pkg=erc20 --out=contract/go/erc20/erc20.go
	abigen --bin=contract/abi/nfts/XQuestNfts.bin --abi=contract/abi/nfts/XQuestNfts.abi --pkg=nfts --out=contract/go/nfts/nfts.go
