...
// func model.ConvertRewards(entityRewards []entity.Reward) []model.Reward {
...
// func model.ConvertConditions(entityConditions []entity.Condition) []model.Condition {
...
// func model.ConvertCategory(category *entity.Category) model.Category {
// 	if category == nil {
...
// func model.ConvertRole(role *entity.Role) model.Role {
// 	if role == nil {
// 		return model.Role{}
// 	}
...
// func model.ConvertCommunity(community *entity.Community, totalQuests int) model.Community {
// 	if community == nil {
...
// func model.ConvertBadge(badge *entity.Badge) model.Badge {
// 	if badge == nil {
// 		return model.Badge{}
// 	}
...
// func model.ConvertQuest(quest *entity.Quest, community model.Community, category model.Category) model.Quest {
// 	if quest == nil {
// 		return model.Quest{}
// 	}
...
// 		Points:         quest.Points,
// 		Rewards:        model.ConvertRewards(quest.Rewards),
// 		ConditionOp:    string(quest.ConditionOp),
// 		Conditions:     model.ConvertConditions(quest.Conditions),
...
// func model.ConvertClaimedQuest(
...
// func model.ConvertGameMap(gameMap *entity.GameMap) model.GameMap {
// 	if gameMap == nil {
...
// func model.ConvertGameCharacter(character *entity.GameCharacter) model.GameCharacter {
// 	if character == nil {
...
// func model.ConvertGameCommunityCharacter(
...
// func model.ConvertGameUserCharacter(
...
// func model.ConvertGameRoom(gameRoom *entity.GameRoom, gameMap model.GameMap) model.GameRoom {
// 	if gameRoom == nil {
...
// func model.ConvertDiscordRole(role discord.Role) model.DiscordRole {
...
// func model.ConvertBlockchainConnection(c *entity.BlockchainConnection) model.BlockchainConnection {
// 	if c == nil {
...
// func model.ConvertBlockchain(b *entity.Blockchain, connections []model.BlockchainConnection) model.Blockchain {
// 	if b == nil {
...
// func model.ConvertBlockchainTransaction(tx *entity.BlockchainTransaction) model.BlockchainTransaction {
// 	if tx == nil {
...
// func model.ConvertBlockchainToken(token *entity.BlockchainToken) model.BlockchainToken {
// 	if token == nil {
...
// func model.ConvertChatMessage(msg *entity.ChatMessage, author model.User, reactions []model.ChatReactionState) model.ChatMessage {
// 	if msg == nil {
...
// func model.ConvertChatChannel(channel *entity.ChatChannel, communityHandle string) model.ChatChannel {
// 	if channel == nil {
...
// func model.ConvertLotteryEvent(
...
// func model.ConvertLotteryPrize(prize *entity.LotteryPrize) model.LotteryPrize {
// 	if prize == nil {
...
// 		Points:           prize.Points,
// 		Rewards:          model.ConvertRewards(prize.Rewards),
// 		AvailableRewards: prize.AvailableRewards,
// 	}
// }

// func model.ConvertLotteryWinner(
