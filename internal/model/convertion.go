...
func ConvertGameMap(gameMap *entity.GameMap) GameMap {
	if gameMap == nil {
		return GameMap{}
	}
...
func ConvertGameCharacter(character *entity.GameCharacter) GameCharacter {
	if character == nil {
...
) GameCommunityCharacter {
	if communityCharacter == nil {
		return GameCommunityCharacter{}
	}
...
func ConvertGameRoom(gameRoom *entity.GameRoom, gameMap GameMap) GameRoom {
	if gameRoom == nil {
		return GameRoom{}
	}

	if gameMap.ID == "" {
		gameMap = GameMap{ID: gameRoom.MapID}
	}
