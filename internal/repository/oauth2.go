...
type OAuth2Repository interface {
	...
	GetByUserID(ctx xcontext.Context, userID string) ([]entity.OAuth2, error)
}
...
func (r *oauth2Repository) GetByUserID(ctx xcontext.Context, userID string) ([]entity.OAuth2, error) {
