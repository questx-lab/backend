...
func (r *chatMessageRepository) GetMessageByID(ctx context.Context, id string) (*entity.ChatMessage, error) {
...
func (r *chatMessageRepository) DeleteMessageByID(ctx context.Context, id string) error {
